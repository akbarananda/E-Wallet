...
public class HomePage implements ControllerInterface {
    ...
    public void beliPulsa() {
        ...
        x: do {
            ...
            if (pilih > Storage.getPulsaList().size()) {
                System.out.println("Tidak ada Nominal entity.Pulsa yang dipilih");
                System.out.println("----------------------------------------------");
                System.out.println();
            } else {
                ...
                do {
                    ...
                    if (Auth.verifPin(pin)) {
                        if (akun.dompet.getSaldo().getSaldo() >= totalHarga) {
                            ...
                            System.out.println("Kamu telah membeli Voucher entity.Pulsa senilai Rp."
                            ...
                            System.out.println("entity.Saldo anda tidak cukup!");
                            System.out.println("----------------------------------------------");
                            System.out.print("Lanjut...");
                            scanner.nextLine();
                            System.out.println();
    ...
    public void cekSaldo() {
        ...
        do {
            ...
            if (Auth.verifPin(pin)) {
                ...
                int pemasukan = akun.dompet.getPemasukan();
                int pengeluaran = akun.dompet.getPengeluaran();
                System.out.printf("Pemasukan      : Rp.%s\n", Rupiah.format(pemasukan));
                System.out.printf("Pengeluaran    : Rp.%s\n", Rupiah.format(pengeluaran));
                System.out.printf("entity.Saldo saat ini : Rp.%s\n", Rupiah.format(saldo));
                System.out.println("----------------------------------------------");
                System.out.print("Lanjut...");
                scanner.nextLine();
                System.out.println();
    ...
    public void lihatTransaksi() {
        ...
        for (Transaksi pembelian : dompet.getDaftarTransaksi()) {
            ...
            if (pembelian instanceof Pulsa) {
                ...
                System.out.println("entity.Pulsa              : Rp." + pulsa.getvPulsa().getTitle());
                ...
                System.out.println("Tanggal entity.TopUp      : " + pembelian.getTanggalTransaksi());
                System.out.println("Nominal entity.TopUp      : Rp." + pembelian.getNominalHarga());
            }
            System.out.println("----------------------------------------------");
        }
    }
